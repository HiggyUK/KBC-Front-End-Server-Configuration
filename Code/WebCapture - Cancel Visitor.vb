...
Module Script
	Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim BookedVisits = "C:\Kofax\MobileDemo\Settings\BookedVisits\" & eventData.User.UserName
	...
	Sub Visitors_OnChange(ByVal eventData As ClientEventData)
		...
		vsSelected = "C:\Kofax\CompleteDemo\Settings\BookedVisits\" & eventData.User.UserName & "\" &  vsList.Value & ".txt"
