...
Module Script
    Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim vehicleData  As String = "C:\Kofax\MobileDemo\Data\LiveStock\" + eventData.User.UserName
		...
		If (Directory.Exists(vehicleData)) Then
		...
		If vehicleCount = 0 Then
			Dim listItem As listItem = New ListItem("No Vehicles Found - Use Delivery Booking First", "No Vehicles Found")
			vehicleList.Items.Add(listItem)
		End If
	...
	Sub VehicleReg_OnChange(ByVal eventData As ClientEventData)
		...
		Dim deliveryData  As String = "C:\Kofax\MobileDemo\Data\LiveStock\" + eventData.User.UserName + "\" + vehicleReg
	...
	Sub DeliveryDate_OnChange(ByVal eventData As ClientEventData)
		...
		Dim deliveryList As ListField = eventData.Form.Fields.GetField("DeliveryNumber")
		Dim deliveryData  As String = "C:\Kofax\MobileDemo\Data\LiveStock\" + eventData.User.UserName + "\" + vehicleReg +"\" + deliveryDate
