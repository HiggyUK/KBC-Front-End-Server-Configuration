...
Module Script
	Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim fileEntries As String() = Directory.GetFiles("C:\Kofax\MobileDemo\Settings\TimeSheet\ToApprove\" & UserName,"*.txt")
		Dim fileName As String
		For Each fileName In fileEntries
			If fileName <> "-DO NOT DELETE-.txt" Then
				fileName = left(fileName,len(fileName)-4)
				tsFileName = right(fileName,len(fileName)-len("C:\Kofax\MobileDemo\Settings\TimeSheet\ToApprove\" & UserName)-1)
	...
	Sub TimeSheet_OnChange(ByVal eventData As ClientEventData)
		...
		tsSelected = "C:\Kofax\MobileDemo\Settings\TimeSheet\ToApprove\" & UserName & "\" &  tsList.Value & ".txt"
