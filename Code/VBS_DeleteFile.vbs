Sub DeleteFile_OnLoad
	...
	fso.DeleteFile("C:\Kofax\MobileDemo\Settings\TimeSheet\ToApprove\"  & UserName & "\" & fileName & ".txt")
	...
	If Not(OutputKDocument Is Nothing) Then
		OutputKDocument.FilePath = "C:\Kofax\MobileDemo\Settings\TimeSheet\ToApprove\" & UserName & "\"  & fileName & ".PDF"
