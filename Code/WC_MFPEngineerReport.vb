...
Module Script
	...
	Sub CustomerID_OnChange(ByVal eventData As ClientEventData)
		...
		Dim customerTextFile As String = "C:\Kofax\MobileDemo\Settings\FieldService\Customers\" + customerID + ".txt"
	...
	Sub MachineID_OnChange(ByVal eventData As ClientEventData)
		...
		Dim machineTextFile As String = "C:\Kofax\MobileDemo\Settings\FieldService\Machines\" + machineID + ".txt"
		Dim txtRead As String
		Dim txtLine As String()
