...
Module Script
	...
	Sub DeliveryID_OnChange(ByVal eventData As ClientEventData)
		...
		If (File.Exists("C:\Kofax\MobileDemo\Settings\ProofofDelivery\DeliveryBarcodes.txt")) Then
			Dim objReader As StreamReader = New System.IO.StreamReader("C:\Kofax\MobileDemo\Settings\ProofofDelivery\DeliveryBarcodes.txt")
			Do 
