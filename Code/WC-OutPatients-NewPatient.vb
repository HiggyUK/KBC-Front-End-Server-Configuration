...
Module Script
	Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim DocumentTypeTextFile As String = "C:\Kofax\CompleteDemo\Settings\PatientRecords\DocumentList.txt"
		...
		Dim ConsultantTextFile As String = "C:\Kofax\CompleteDemo\Settings\PatientRecords\ConsultantList.txt"
		...
		Dim patientDir As String = "C:\Kofax\CompleteDeom\Output\PatientRecords"
