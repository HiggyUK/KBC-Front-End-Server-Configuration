...
Module Script
	Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim DocumentTypeTextFile As String = "C:\Kofax\WebCapture-00001-HeathCare-PatientRecords\Settings\DocumentList.txt"
		...
		Dim ConsultantTextFile As String = "C:\Kofax\WebCapture-00001-HeathCare-PatientRecords\Settings\ConsultantList.txt"
	...
	Sub Search_OnClick(ByVal eventData As ClientEventData)
		...
		Dim patientDir As String = "C:\Kofax\WebCapture-00001-HeathCare-PatientRecords\Output\"
