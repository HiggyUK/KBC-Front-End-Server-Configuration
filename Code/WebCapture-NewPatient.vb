...
Module Script
	Sub Form_OnLoad(ByVal eventData As ClientEventData)
		...
		Dim DocumentTypeTextFile As String = "C:\Kofax\XeroxEIP-00001-HeathCare-PatientRecords\Settings\DocumentList.txt"
		...
		Dim ConsultantTextFile As String = "C:\Kofax\XeroxEIP-00001-HeathCare-PatientRecords\Settings\ConsultantList.txt"
