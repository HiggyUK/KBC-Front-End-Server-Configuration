...
Module Script
	...
	Sub PatientNumber_OnChange(ByVal eventData As ClientEventData)
		...
		Dim dob As String =""
		Dim userAttrib As Integer
		Dim userHomeFolder As String
		
		For userAttrib = 1 To eventData.User.UserAttributes.Count 
			If eventData.User.UserAttributes.Item(userAttrib - 1).Name = "homeDirectory" Then
				userHomeFolder = 	eventData.User.UserAttributes.Item(userAttrib - 1).Data
			End If
		Next
		...
		Dim patientTextFile As String = "C:\Kofax\MobileDemo\Settings\HealthCare\Patients\" + patientID + ".txt"
